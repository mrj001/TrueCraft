                    ...
                    if (noise.Value2D(blockX, blockZ) > 0)
                    {
                        ...
                        if (chunk.GetBlockID(blockLocation) == biome.SurfaceBlock && plantPosition.Y < Chunk.Height)
                        {
                            ...
                            if (chance < 1)
                            {
                                ...
                                if (biome.Plants.Contains(PlantSpecies.Deadbush) && bushNoise > 1 && chunk.GetBlockID(blockLocation) == (byte)BlockIDs.Sand)
                                {
